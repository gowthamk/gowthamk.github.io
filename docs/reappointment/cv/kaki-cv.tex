...
\pagestyle{fancy}
\fancyfoot[R]{\today\ \currenttime}
\renewcommand{\headrulewidth}{0pt}
\fancypagestyle{plain}{
  %\fancyhf{} % clear all header and footer fields
  %\fancyhead[L]{\Large Gowtham Kaki {\color{Gray} {$\vert$} Service Statement} }
  \fancyfoot[R]{\today\ \currenttime}
  \renewcommand{\headrulewidth}{0pt}
}
...
\begin{enumerate}
\item Pranav Subramanian (BS), Fall 2022--Spring 2023,
...
\begin{region} {Journal or Journal-Equivalent Publications}{{J}1}{11}
...
\begin{region} {Journal Pre-prints}{{J}{12}}{14}
...
\begin{publication}{}
		{Effectively-Propositional Higher-Order Functional Programming} {Apr
    2026}{\underline{Nicholas Lewchenko}, \ugkaki, and \bec} {Under the
    editorial process (Major Revision) at the Proceedings of the ACM on
    Programming Languages (PACMPL), issue OOPSLA 2026}{Full paper (25
    pages)}
\end{publication}

\end{region}

\begin{region} {Peer-Reviewed Conference Publications}{{C}1}{3}
    ...
    {Pages 8:1 - 8:18; Accceptance rate: 57\%}
  \end{publication}
    ...
    {Pages 11:1-11:31; Accceptance rate: 39\%}
  \end{publication}
...
\begin{region} {Conference Pre-prints}{{C}{4}}{6}

\begin{publication}{url}
		{Ravencheck: Effectively Propositional Reasonign for Rust}
    {Jan 2026}{\underline{Kunha Kim}, \underline{Nicholas Lewchenko}, \bec,
    and \ugkaki}
    {Under submission to International Conference on Computer-Aided
    Verification (CAV), 2026}{Tool paper (10 pages)}
\end{publication}

\begin{publication}{url}
		{Parameter Inference by Neural Network-Guided Elimination of
    Latent Variables in Ordinary Differential Equations}{Jan 2026}
    {\underline{Oscar Bender-Stone}, \ugkaki, Rebecca Morrison, and Sriram
    Sankaranarayanan} {Under submission to International Conference on
    Machine Learning (ICML)}{Full paper (8 pages)}
\end{publication}
